                ...
                if ($name == 'sbmonth'){
                    DB::table('for_approval')->insert(
                        [
                            ...
                            'request_for_approval' => $request->input($name),
                ...
                if ($name == 'shn'){
                    DB::table('for_approval')->insert(
                        [
                            ...
                            'relationship' => "Student",
                            'request_for_approval' => $request->input($name),
                            'type_of_column' => 'change_student_address',
                            'contact_type' => "NONE",
                            'contact_relationship' => "NONE",
                            'status' => "PENDING"
                        ]
...
if ($name == 'mhn'){
    DB::table('for_approval')->insert(
        [
            ...
            'relationship' => "Mother",
            'request_for_approval' => $request->input($name),
            'type_of_column' => 'change_Mother_address',
            'contact_type' => "NONE",
            'contact_relationship' => "NONE",
            'status' => "PENDING"
        ]
...
if ($name == 'fhn'){
    DB::table('for_approval')->insert(
        [
            ...
            'relationship' => "Father",
            'request_for_approval' => $request->input($name),
            'type_of_column' => 'change_Father_address',
            'contact_type' => "NONE",
            'contact_relationship' => "NONE",
            'status' => "PENDING"
        ]
...
//        }
//
//        if ($s_change_subdivision_building !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
...
//        }
//
//        if ($s_change_province_municipality !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
...
//        }
//
//        if ($m_change_subdivision_building !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
...
//        }
//
//        if ($m_change_province_municipality !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
...
//        }
//
//        if ($f_change_subdivision_building !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
...
//        }
//
//        if ($f_change_province_municipality !== ){
//
//            DB::table('for_approval')->insert(
//                [
//                    'student_id' => $user_id,
